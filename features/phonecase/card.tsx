...
function Card({
  ...
  return (
    <div className="aspect-[9/18] w-full border border-stone-700 hover:-translate-y-[1px] duration-300 bg-stone-900 rounded-2xl md:rounded-3xl overflow-hidden relative cursor-pointer">
